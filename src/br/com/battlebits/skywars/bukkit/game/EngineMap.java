...
public class EngineMap {
    ...
    public EngineMap(String name, File world, InputStream stream) throws Exception {
        this.name = name;
        this.world = world;
        this.stream = stream;
        extractFiles();
    ...
    public void extractFiles() throws Exception {
        ...
        try (ZipInputStream zis = new ZipInputStream(stream)) {
            ...
            while (ze != null) {
                String path = world.getAbsolutePath() + File.separator + ze.getName();
                if (!ze.isDirectory()) {
    ...
    public void postWorld() throws Exception {
        ...
        for (Map.Entry<String, JsonElement> entry : chests.entrySet()) {
            ...
            Main.getInstance().logWarn(entry.getKey() + " : " + array.size());
